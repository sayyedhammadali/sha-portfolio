        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
            <li className="nav-item active">
              <a className="nav-link"  onClick={scroll} data-id="landing">home</a>
            </li>
            <li className="nav-item">
              <a className="nav-link"  onClick={scroll} data-id="about">about</a>
            </li>
            <li className="nav-item">
              <a className="nav-link"  onClick={scroll} data-id="portfolio">portfolio</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" onClick={scroll} data-id="contact">contact</a>
            </li>
          </ul>
        </div>
      </nav>
